...
class PublisherTestCase(
    ...
    def test_main_flow(self):
        ...
        tst_obj.add_subscribers(
            mock_subscriber_one, sub_space=TST_SUB_SPACE_ONE
        )
        tst_obj.add_subscribers(
            mock_subscriber_two, sub_space=TST_SUB_SPACE_TWO
        )
        ...
        tst_obj.remove_subscribers(
            mock_subscriber_not_registered, sub_space=Mock()
        )
